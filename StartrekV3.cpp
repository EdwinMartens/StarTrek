...
void NewGame()
{
	 ...
	 if (g_pMenu != NULL)
     {
         ...
         g_pMenu->AddMenuItem("Save",SetupSaveScreen);
        ...
        if (blNewSector)
        {
            ...
            if ( g_pUniverse->HasSingularity(g_pEnterprise->m_nSectorPositionX ,g_pEnterprise->m_nSectorPositionY))
            {
                ...
                switch(z)
                {
                    ...
                    case 5:
                         g_pCommunication->AddMessage(1, CREW_SPOCK,"We feel the remains of a dead star...");
                    break;
                }
     ...
     switch (g_nScreenMode)
     {
        ...
        if (g_pEnterprise!=NULL)
        {
         ...
         case MODE_COMMUNICATION:
              ...
              g_pEnterprise->GetTransporter()->draw(90,480,100,250,g_pDisplay);
         break;
